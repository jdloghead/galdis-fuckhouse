...
public class GameControllerScript : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        this.UpdateNotebookCount(); //Update the notebook ha count
    ...
    private void UpdateNotebookCount()
    {
        if (this.mode == "story")
        {
            this.notebookCount.text = this.notebooks.ToString() + "/25" ;
        }
        else
        {
            this.notebookCount.text = this.notebooks.ToString() + " ";
        }
        if (this.notebooks == 25 & this.mode == "story")
        {
    ...
    public void DeactivateLearningGame(GameObject subject)
    {
        ...
        else if (this.notebooks == 25 & this.mode == "story") // Plays the all 7 notebook sound
        {
    ...
    private void IncreaseItemSelection()
    {
        ...
        this.itemSelect.anchoredPosition = new Vector3((float)this.itemSelectOffset[this.itemSelected], OffsetY, 0f); //Moves the item selector background(the red rectangle)
        this.UpdateItemName();
    }
