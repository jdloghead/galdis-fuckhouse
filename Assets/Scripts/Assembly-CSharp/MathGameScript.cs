...
public class MathGameScript : MonoBehaviour
{
    ...
    private void NewProblem()
    {
        ...
        else
        {
            ...
            {
                this.questionText.text = "you fucking noob";
            ...
            {
                int num2 = Mathf.RoundToInt(UnityEngine.Random.Range(0f, 3f));
    ...
    public void CheckAnswer()
    {
        ...
        {
            base.StartCoroutine(this.CheatText("haha lmfao it wont work"));
        }
